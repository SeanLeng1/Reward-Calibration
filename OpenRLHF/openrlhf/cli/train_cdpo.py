...
from openrlhf.trainer import CalibratedDPOTrainer
...
def train(args):
    ...
    train_dataset = CalibratedRewardDataset(
    ...
    strategy.print("Example prompt: ", train_dataset.confidence_prompts_chosen[0])
    strategy.print('-'*100)
    strategy.print("Example cwh: ", train_dataset.cwhs[0])
    strategy.print('-'*100)
    strategy.print("Example cwl: ", train_dataset.cwls[0])
    ...
    trainer = CalibratedDPOTrainer(
        ...
        cdpo_coefficient=args.cdpo_coefficient
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cdpo_coefficient", type=float, default=0.5)
