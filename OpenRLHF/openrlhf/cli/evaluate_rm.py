...
def train(args):
    ...
    if args.customized_reward_model_name:
        ...
        # noqa
        elif args.customized_reward_model_name in ['InterNLM', 'Mistral', 'Gemma']:
    ...
    strategy.print("Example prompt: ", train_dataset.chosens[0])
    strategy.print('-'*100)
    strategy.print("Example prompt: ", train_dataset.rejects[0])
