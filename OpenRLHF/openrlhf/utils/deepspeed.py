...
from openrlhf.models import Actor, DefaultRewardModel
...
class DeepspeedStrategy(ABC):
    ...
    def create_optimizer(self, model, **kwargs) -> Optimizer:
        if isinstance(model, Actor) or isinstance(model, DefaultRewardModel):
            model = model.model
        # Optimizer
    ...
    def _ds_init_train_model(self, model, optim, scheduler):
        is_actor = isinstance(model, Actor) or isinstance(model, DefaultRewardModel)
